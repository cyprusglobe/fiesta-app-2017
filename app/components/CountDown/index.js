...
class CountDown extends Component {
  ...
  render() {
    ...
    return (
      <View style={{alignItems: 'center', justifyContent: 'center', flexDirection: 'row', borderWidth: StyleSheet.hairlineWidth, borderColor: 'white', padding: 5, borderRadius: 5}}>
        <View style={{flexDirection: 'column', alignItems: 'center', paddingHorizontal: 10}}>
          <Text style={{fontWeight: '200', color: 'white'}}>Days</Text>
          <Text style={{fontWeight: 'bold', color: 'white'}}>{data.days}</Text>
        </View>
        <View style={{flexDirection: 'column', alignItems: 'center', paddingHorizontal: 10}}>
          <Text style={{fontWeight: '200', color: 'white'}}>Hours</Text>
          <Text style={{fontWeight: 'bold', color: 'white'}}>{data.hours}</Text>
        </View>
        <View style={{flexDirection: 'column', alignItems: 'center', paddingHorizontal: 10}}>
          <Text style={{fontWeight: '200', color: 'white'}}>Minutes</Text>
          <Text style={{fontWeight: 'bold', color: 'white'}}>{data.minutes}</Text>
        </View>
        <View style={{flexDirection: 'column', alignItems: 'center', paddingHorizontal: 10}}>
          <Text style={{fontWeight: '200', color: 'white'}}>Seconds</Text>
          <Text style={{fontWeight: 'bold', color: 'white'}}>{data.seconds}</Text>
        </View>
      </View>
    )
  }
